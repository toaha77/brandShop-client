...
const Details = () => {
  ...
  console.log(loader);
    ...
    <div id="slide1" className="carousel-item relative w-full h-[400px]">
      <img src='/pexels-jesse-zheng-1213294.jpg' className="w-full h-[400px]" />
    ...
    <div id="slide2" className="carousel-item relative w-full h-[400px]">
      <img src="/pexels-mike-bird-170811.jpg" className="w-full h-[400px]" />
      <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
    ...
    <div id="slide3" className="carousel-item relative w-full h-[400px]">
      <img src="/pexels-mike-noga-3608542.jpg" className="w-full h-[400px] " />
      <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
        <a href="#slide2" className="btn btn-circle">❮</a> 
        <a href="#slide4" className="btn btn-circle">❯</a>
      </div>
